...
export function BulkLinkPanel({ projectId, onSuccess, onDeleteSuccess }: { projectId: number; onSuccess: (result: BulkLinkResult) => void; onDeleteSuccess: (result: BulkDeleteResult) => void }) {
